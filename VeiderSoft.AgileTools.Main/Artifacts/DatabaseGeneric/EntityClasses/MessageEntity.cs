...
namespace ORMFile.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> CTor</summary>
		/// <param name="id">PK value for Message which data should be fetched into this Message object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MessageEntity(System.Int32 id):base("MessageEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this MessageEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MessageEntity(System.Int32 id, IValidator validator):base("MessageEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <summary> The Active property of the Entity Message<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Message"."Active"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Active
		{
			get { return (System.Boolean)GetValue((int)MessageFieldIndex.Active, true); }
			set	{ SetValue((int)MessageFieldIndex.Active, value); }
		}

		/// <summary> The Id property of the Entity Message<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Message"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)MessageFieldIndex.Id, true); }
			set	{ SetValue((int)MessageFieldIndex.Id, value); }
		}
		...
		public virtual System.String Message
		{
			...
			set	{ SetValue((int)MessageFieldIndex.Message, value); }
		}

		/// <summary> The Tag property of the Entity Message<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Message"."Tag"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 16<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Tag
		{
			get { return (System.String)GetValue((int)MessageFieldIndex.Tag, true); }
			set	{ SetValue((int)MessageFieldIndex.Tag, value); }
		}
		...
		/// <summary>Returns the ORMFile.EntityType enum value for this entity.</summary>
		[Browsable(false), XmlIgnore]
		protected override int LLBLGenProEntityTypeValue 
		{ 
			get { return (int)ORMFile.EntityType.MessageEntity; }
		}
