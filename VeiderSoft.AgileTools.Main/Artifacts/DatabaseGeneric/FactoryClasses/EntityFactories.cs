...
using ORMFile.RelationClasses;
using SD.LLBLGen.Pro.ORMSupportClasses;

namespace ORMFile.FactoryClasses
{
	...
	{
		private readonly ORMFile.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, ORMFile.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		{
			return GeneralEntityFactory.Create((ORMFile.EntityType)entityTypeValue);
		}
	...
	public partial class MessageEntityFactory : EntityFactoryBase2<MessageEntity> {
		/// <summary>CTor</summary>
		public MessageEntityFactory() : base("MessageEntity", ORMFile.EntityType.MessageEntity, false) { }
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(ORMFile.EntityType entityTypeToCreate)
		{
			IEntityFactory2 factoryToUse = null;
			switch(entityTypeToCreate)
			{
				case ORMFile.EntityType.MessageEntity:
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(ORMFile.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((ORMFile.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the ORMFile.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(ORMFile.EntityType typeOfEntity)
		{
	...
	{
		/// <summary>Gets the factory of the Entity type with the ORMFile.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (ORMFile.EntityType)Enum.Parse(typeof(ORMFile.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((ORMFile.EntityType)Enum.Parse(typeof(ORMFile.EntityType), leftOperandEntityName, false), joinType, (ORMFile.EntityType)Enum.Parse(typeof(ORMFile.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the ORMFile.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((ORMFile.EntityType)entityTypeValue);
		}
