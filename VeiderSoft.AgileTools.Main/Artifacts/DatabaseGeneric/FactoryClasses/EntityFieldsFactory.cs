...
namespace ORMFile.FactoryClasses
{
	...
	{
		private static readonly Dictionary<ORMFile.EntityType, string> _entityTypeNamesCache = new Dictionary<ORMFile.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(ORMFile.EntityType value in Enum.GetValues(typeof(ORMFile.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(ORMFile.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(ORMFile.EntityType relatedEntityType)
		{
